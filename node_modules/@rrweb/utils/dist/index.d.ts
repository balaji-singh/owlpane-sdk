...
export declare function firstChild(n: Node): ChildNode | null;
...
export declare function lastChild(n: Node): ChildNode | null;
...
export declare function nextSibling(n: Node): ChildNode | null;
...
export declare function previousSibling(n: Node): ChildNode | null;
